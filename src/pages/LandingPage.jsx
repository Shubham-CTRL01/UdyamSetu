  ...
  return (
    <div className="flex flex-col bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200 overflow-hidden">
      ...
      <div className="px-5 py-4 border-t border-slate-100 bg-slate-50/50 flex items-center justify-between">
        ...
        <Link to="/login" className="flex items-center gap-1.5 px-3.5 py-2 text-xs font-semibold rounded-lg bg-[#0B192C] text-white hover:bg-[#1E3E62] transition-colors">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-20 lg:pt-24 lg:pb-28">
          <div className="max-w-3xl">
            ...
            <div className="flex items-center gap-0 bg-white rounded-2xl p-1.5 shadow-2xl max-w-2xl mb-8">
              ...
              <Link to="/schemes" className="px-5 py-2.5 bg-[#0B192C] text-white text-sm font-semibold rounded-xl hover:bg-[#1E3E62] transition-colors whitespace-nowrap">
                Explore Challenges
              </Link>
            </div>
      ...
      <section className="bg-gradient-to-br from-[#0B192C] via-[#10243E] to-[#1E3E62] py-16 px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            ...
            <Link to="/login" className="flex items-center gap-2 px-6 py-3 bg-white/10 hover:bg-white/20 border border-white/20 text-white font-semibold text-sm rounded-xl transition-colors"><Users className="w-4 h-4" /> Schedule a Demo</Link>
          </div>
        </div>
      </section>
    </div>
